...
public class editarUsuario extends javax.swing.JFrame {
    ...
    Usuario user;
    int id_usuario;
    private verUsuarios verUsuarios;

    public editarUsuario(verUsuarios verUsuarios,controladoraLogicaLogin control, int id_usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        texto01.setText("Actualizar Información del Usuario");
        ...
        texto02.setText("Modifica los datos registrados");
        ...
        texto03.setText("Revisa los datos y aplica cambios");
        ...
        principalLayout.setHorizontalGroup(
            ...
            .addComponent(texto01, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)
            .addComponent(texto02, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        loginLabel.setText("EDITAR USUARIO");
        ...
        IngresarBtnTxt.setText("ACTUALIZAR");
        ...
        IngresarBtnLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, IngresarBtnLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(IngresarBtnTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    user = control.traerUsuario(id_usuario);
     ...
     userTxt.setText(user.getNombreUsuario());
     passTxt.setText(user.getContrasenia());
     
      List<rol> listaRoles = control.traerRoles();
        
        if (listaRoles!=null) {
             for (rol rol: listaRoles) {
                rolCmb.addItem(rol.getNombreRol());
            }
        }        
     
     String rol = user.getUnRol().getNombreRol();
     
     int cantidadItems = rolCmb.getItemCount();
     for (int i=0; i<cantidadItems; i++) {
         if (String.valueOf(rolCmb.getItemAt(i)).equals(rol)) {
             rolCmb.setSelectedIndex(i);
